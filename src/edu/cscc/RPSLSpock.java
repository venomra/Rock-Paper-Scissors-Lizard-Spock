...
public class RPSLSpock {
    ...
    /**
     *
     * @param pick a string which checks if the input is null and returns false or if not returns one of the picked value
     * @return returns false if the input is empty else returns the     ROCK, PAPER, SCISORS, LIZARD, SPOCK as per input
     */
    ...
    /**
     *
     * @return returns the value for computer which is picked randomly from
     */
     ...
     * @param c_pick
     * @param h_pick
     * @return returns the combination of choices for computer to win the game
     */

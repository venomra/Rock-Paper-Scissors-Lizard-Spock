...
public class RPSLSpockTest {
    ...
    /**
     * Test is checkExtremeValues() method
     * Test the input value is other than  {rock,paper,scissors,lizard, or spock} set to false
     * Test the input is null and set to fasle
     */
